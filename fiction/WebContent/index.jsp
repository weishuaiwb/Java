                ...
                <ul class="nav" id="side-menu">
                        ...
                        <div class="dropdown profile-element">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                               ...
                               <span class="block m-t-xs"><strong class="font-bold">${user.nickname}</strong></span>
                                <span class="text-muted text-xs block">钻石用户<b class="caret"></b></span>
                                </span>
                            </a>
                            <ul class="dropdown-menu animated fadeInRight m-t-xs">
                                <!-- <li><a class="J_menuItem" href="form_avatar.html">修改头像</a>
                                </li> -->
                                <li><a class="J_menuItem" href="UserInfo.jsp">完善个人信息</a>
                                </li>
                                <li><a class="J_menuItem" href="us.html">联系我们</a>
                                </li>
                    ...
                    <li>
                    	...
                    	<ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="User.jsp" data-index="0">个人主页</a>
                            </li>

                            <li>
                                <a class="J_menuItem" href="UserInfo.jsp">信息修改</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="">头像修改</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                    	<a href="#">
                            ...
                            <span class="nav-label">声望进阶</span>
                            <span class="fa arrow"></span>
                        </a>
                    	<ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="" data-index="0">经验等级</a>
                            </li>

                            <li>
                                <a class="J_menuItem" href="">任务</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="">徽章/称号/认证</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="#">
                            ...
                            <span class="nav-label">作者专栏</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a class="J_menuItem" href="newfiction.jsp" data-index="0">开新书</a>
                            </li>

                            <li>
                                <a class="J_menuItem" href="text?method=findText">书录管理</a>
                            </li>
                            <li>
                                <a class="J_menuItem" href="">作者相关</a>
                            </li>
                            <!-- <li>
               		 ...
               		 <li>
                        <a class="J_menuItem" href="layouts.html"><i class="fa fa-columns"></i> <span class="nav-label">次元飞跃</span></a>
                    </li>
                    
                    <li>
                        <a href="#">
                            <i class="fa fa fa-bar-chart-o"></i>
                            <span class="nav-label">好玩推荐</span>
                            <span class="fa arrow"></span>
                        </a>
                        <ul class="nav nav-second-level">
                            <li>
 ...
 <!--                   <li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li><a class="J_menuItem" href="novelMa.jsp">404页面</a>
                            </li>
 ...
 -->
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
                    ...
                    <a class="navbar-minimalize minimalize-styl-2 btn btn-primary " href="#"><i class="fa fa-bars"></i> </a>
                        <form  class="navbar-form-custom " method="get" action="text">
                        	<input type="hidden" value="searchText" name="method">
                            <div class="form-group">
                            	<div class="input-group">
                            		 <input type="text" placeholder="请输入书名 …" class="form-control" name="top-search" id="top-search">
                            		<div class="input-group-addon" ><button class="btn btn-success " type="submit">查询</button></div>
                            	</div>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                    	<button class="btn btn-default"><a href="text?method=findAllList" target="_blank" style="text-decoration:none;color:white;">首页</a></button>
                        <li class="dropdown">
            ...
            <div class="row content-tabs">
                ...
                <a href="user?method=quit" class="roll-nav roll-right J_tabExit"><i class="fa fa fa-sign-out"></i> 退出</a>
            </div>
            <div class="row J_mainContent" id="content-main">
                <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="User.jsp" frameborder="0" data-id="index_v1.html" seamless></iframe>
            </div>
            <div class="footer">
